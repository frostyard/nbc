...
func TestInstallTmpfilesConfig(t *testing.T) {
	t.Run("dry run does not create files", func(t *testing.T) {
		targetDir := t.TempDir()
		err := InstallTmpfilesConfig(targetDir, true, NoopReporter{})
		if err != nil {
	...
	t.Run("creates tmpfiles.d config", func(t *testing.T) {
		targetDir := t.TempDir()
		err := InstallTmpfilesConfig(targetDir, false, NoopReporter{})
		if err != nil {
...
func TestWriteSystemConfigToVar(t *testing.T) {
	t.Run("dry run does not create files", func(t *testing.T) {
		...
		err := WriteSystemConfigToVar(varMountPoint, config, true, NoopReporter{})
		if err != nil {
	...
	t.Run("creates config file", func(t *testing.T) {
		...
		err := WriteSystemConfigToVar(varMountPoint, config, false, NoopReporter{})
		if err != nil {
